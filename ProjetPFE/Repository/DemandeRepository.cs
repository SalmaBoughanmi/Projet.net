            ...
            using (var connection = _context.CreateConnection())
            {
                ...
                using (var transaction = connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        var archiveQuery = @"INSERT INTO archive (demande_id, nb_a_exp, type_demande, titre_fonction, nature_contrat, lien_fichier, nom_fichier, remarque, collaborateur_remp, affectation, motif_chef, motif_rh, motif_ds)
                                     VALUES (@demande_id, @nb_a_exp, @type_demande, @titre_fonction, @nature_contrat, @lien_fichier, @nom_fichier, @remarque, @collaborateur_remp, @affectation, @motif_chef, @motif_rh, @motif_ds)";
